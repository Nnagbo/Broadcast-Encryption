<div class="modal fade" id="messageBroadcastModal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content bbn-modal">
                    <form method="post" id="compose-modal" action="{{ url('broadcast-message')}}">
                    {{ csrf_field() }}
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group ">
                                <textarea class="form-control" name="message" id="message" placeholder="Type your message..." required="required">{{ old('message') }}</textarea>
                            </div><br />
                        </div>
